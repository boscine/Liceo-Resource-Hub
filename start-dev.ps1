...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd adet-fe-bsit22; `$env:NODE_OPTIONS='--max-old-space-size=1536'; npx ng serve --configuration=development --live-reload=false --progress=false" -WindowStyle Normal
